...
class AmazonSpider(AmazonBaseClass):
    name = 'amazon_cn_reviewers'
    allowed_domains = ["amazon.cn"]
    start_urls = ['http://www.amazon.cn/review/top-reviewers']
    ...
    PAGINATE_URL = 'http://www.amazon.cn/review/top-reviewers/' \
                   'ref=cm_cr_tr_link_next_2?ie=UTF8&page={page}'
